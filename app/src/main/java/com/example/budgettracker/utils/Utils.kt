...
object DateUtils {
    ...
    fun getCurrentMonthId(): String {
        return BudgetPeriodResolver.resolveCurrentMonthId(LocalDate.now(), budgetStartDay)
    }

    fun getMonthIdFor(date: LocalDate, startDay: Int): String {
        return BudgetPeriodResolver.resolveMonthId(date, startDay)
    }
    ...
    fun getMonthStartDate(monthId: String): String {
        return BudgetPeriodResolver.resolveRange(monthId, budgetStartDay).first.toString()
    }

    fun getMonthEndDate(monthId: String): String {
        return BudgetPeriodResolver.resolveRange(monthId, budgetStartDay).second.toString()
    }
